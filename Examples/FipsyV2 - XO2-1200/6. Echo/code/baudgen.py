...
def divisor(baudrate):
    ...
    #CLOCK_HZ = 12080000       #Speed used in Str and Char
    CLOCK_HZ = 2080000 			#Speed used in MIDI Merger
    return round(CLOCK_HZ / baudrate)

if __name__ == "__main__":

    # -- List with the standard baudrates - added MIDI 31250
    baudrates = [115200, 57600, 38400, 31250, 19200, 9600, 4800, 2400, 1200, 600, 300]
