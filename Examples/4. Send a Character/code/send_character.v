...
module MakeFPGA_Top(
  ...
  PIN11, PIN12, PIN13, PIN14, PIN17, PIN18, PIN19, PIN20, LEDn );

// Define all of the above pins as available for general I/O
inout PIN7, PIN9, PIN10, PIN11, PIN12, PIN13, PIN14, PIN17, PIN18, PIN19, PIN20;
// Except the LED, which is only an output, for which driving low lights the LED
output PIN8, LEDn;

// At this level, all named signals are wires
wire PIN7, PIN8, PIN9, PIN10, PIN11, PIN12, PIN13, PIN14, PIN17, PIN18, PIN19, PIN20;
...
defparam OSCH_inst.NOM_FREQ = "12.09";   // Must be one of the allowed frequencies (2.08MHz default)
...
txchar TX0(
          ...
          .rstn(resetline),  //-- Reset (active low)
