...
reg [20:0] counter_register;
reg triggery;

assign LEDn = triggery;
  ...
  begin
	...
	if (rcv == 1'b1)
		begin
			...
			if (bytedata[1]==1'b1)
				begin
					triggery=0; //Turning LED on is 0
				end
		end
	else
		begin
			...
			begin
				if (triggery==0)
					begin
					//Do counter step
					counter_register <= counter_register + 21'b000000000000000000001;
					end
			end
		end
	end
